...
function Slider() {
  ...
  return (
    <div>
      <div className={classes.heading}><span style={{fontSize:"2rem"}} >Bestselling Books</span><span style={{display:"flex"}}><span className={classes.link} style={{ fontSize:"1rem",display:"flex",cursor:"pointer"}}>View All</span><span><ArrowForwardIosTwoToneIcon /></span></span></div>
    <Carousel
...
>
  {BestSelling.map((obj,index)=>{
     return(
      ...
      <img src={obj.coverpage} width="190px" height="240px"/>
